  ...
  return (
    <div>
      ...
      <div className="max-w-4xl mx-auto flex flex-col justify-center items-center h-[80vh] px-5">
          ...
          <div className="fixed inset-0 backdrop-blur-md z-10 flex items-center justify-center px-5">
            <div className="w-96 relative h-auto bg-gray-800 px-4 py-6 rounded-md flex flex-col justify-center items-center">
              ...
              <QRCode
                id="QRCode"
                size={250}
                value={`https://one.relativelyrehan.co/api/qr?id=${qr}`}
                level="L"
              />
                ...
                <button
                  onClick={() => {
                    navigator.clipboard.writeText(
                      `https://one.relativelyrehan.co/api/qr?id=${qr}`
                    );
        ...
        <p className="text-center text-sm sm:text-lg mt-3 mb-8 text-gray-600">
        ...
        <form
          ...
          className="flex flex-col w-full sm:w-2/3 mx-auto gap-6 p-3"
        >
          <div>
            <label
      ...
      <footer className="text-gray-400 flex flex-col items-center justify-center">
        <div className="flex gap-2 items-center">
          ...
          by
          <a
            href="https://relativelyrehan.co"
            target="_blank"
            rel="noopener noreferrer"
            className="text-indigo-300 hover:text-slate-50 text-base"
          >
            Rehan
          </a>
        </div>
